    ...
    actions: {
        async fetchTasks({commit}) {
            try {
                ...
                Swal.fire({
                    title: '! متاسفیم',
                    text: '! دریافت اطلاعات با خطا رو به رو شد',
                    icon: 'error',
        ...
        async storeTask({commit}, title) {
            try {
                ...
                Swal.fire({
                    title: 'تسک وارده با موفقیت اضافه شد',
                    icon: 'success',
                ...
                Swal.fire({
                    title: '! متاسفیم',
                    text: '! ارسال اطلاعات با خطا رو به رو شد',
                    icon: 'error',
                    confirmButtonText: 'تایید'
                });
            }
        ...
        async updateTask({commit}, task) {
            try {
                ...
                Swal.fire({
                    title: '! متاسفیم',
                    text: '! تسک مورد نظر قابل آپدیت نیست',
                    icon: 'error',
                    confirmButtonText: 'تایید'
                });
            }
