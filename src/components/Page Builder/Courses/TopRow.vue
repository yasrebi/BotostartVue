<template>
  <div class="container-newcoureses mx-auto">
    <div class="row-courses flex-column flex-lg-row-reverse d-flex justify-content-between">
      <div class="mb-4 mb-lg-0 d-flex" dir="rtl">


        <svg xmlns="http://www.w3.org/2000/svg" width="30" viewBox="0 0 57 76">
          <defs>
        ...
        <h2 class="fw-bold courses-tutorial ms-2" dir="rtl">دوره های آموزش برنامه نویسی</h2>
        ...
        <div class="free-courses">
          ...
          <div>
            <label class="toggler-wrapper style-1">
              <input @click="filterFreeCourse == !filterFreeCourse" type="checkbox">
